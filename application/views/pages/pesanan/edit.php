                                ...
                                <?php echo form_open('pesanan/update'); ?>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <select class="form-control select2" name="nip"  style="width: 100%;">
                                                    ...
                                                    <?php foreach ($pegawai as $row): ?>
                                                        ...
                                                        <option value="<?php echo $row->nip; ?>" <?php echo $pesanan->nip == $row->nip ? 'selected' : ''; ?>><?php echo $row->nip; ?> &mdash; <?php echo $row->nama_pegawai; ?></option>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7"><input type="number" name="banyak" class="form-control" value="<?php echo $pesanan->banyak; ?>"></div>
                                        </div>
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tanggal</label>
                                            <div class="col-sm-12 col-md-7"><input type="date" name="tanggal_pesanan" class="form-control" value="<?php echo $pesanan->tanggal_pesanan; ?>"></div>
                                        </div>
                                    </div>
