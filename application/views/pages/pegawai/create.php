                        ...
                        <div class="col-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h5 class="float-left mb-0 mt-2">Tambah Pegawai</h5>
                                </div>
                                ...
                                <?php echo form_open('pegawai/store'); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7"><input type="text" name="nip" class="form-control"></div>
                                        </div>
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Pegawai</label>
                                            <div class="col-sm-12 col-md-7"><input type="text" name="nama_pegawai" class="form-control"></div>
                                        </div>
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <select class="custom-select" name="kode_gaji">
                                                    ...
                                                    <?php foreach ($gaji as $row): ?>
                                                        ...
                                                        <option value="<?php echo $row->kode_gaji; ?>">Rp<?php echo format_rupiah($row->gaji_pokok); ?></option>
